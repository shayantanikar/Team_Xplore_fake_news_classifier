...
#### view.py
This forms the link between the classifier and the html webpage. It takes the input from the webpage and using the final_model.sav predicts the output and then prints it back in the webpage.

#### hackanova.html
This is the webpage we have build as the frontend of the whole working model.

#### final_model.sav
After the classifier trains the model, the model gets saved as this file automatically
